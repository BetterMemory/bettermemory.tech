  ...
  return (
    <div className="flex cursor-default h-full selection:bg-black selection:text-white bg-[#F5F4EF] pt-[48px] justify-center">
      <div className="flex m-4 flex-col max-w-3xl w-full bg-[#F5F4EF] item-center">
        ...
        <a className="pt-[24px]">
          We are about to publish our first blog post, which will be available
          in multiple languages, including English, Traditional Chinese, Korean,
          and Japanese. The post will cover our current progress and future
          plans. Stay tuned!
          <br />
          <br />
          ...
          <br />
          <br />
          곧 블로그에 첫 번째 게시글을 게시할 예정입니다. 이 게시글은 영어, 번체
          중국어, 한국어, 일본어를 포함한 여러 언어로 제공됩니다. 회사의 현재
          진행 상황과 향후 계획에 대해 다룰 예정입니다. 많은 관심 부탁드립니다!
          <br />
          <br />
